...
class CfgMagazines
{
	...
	class OPT_HandFlare_WhiteMuzzle_120mm : SmokeShell
	{
		ammo = "Smoke_120mm_AMOS_White";
		displayName = "120mm Smoke Grenade (White)";
		displayNameShort = "120mm White Smoke";
	};

	class OPT_HandFlare_WhiteMuzzle_82mm : SmokeShell
	{
		ammo = "Smoke_82mm_AMOS_White";
		displayName = "82mm Smoke Grenade (White)";
		displayNameShort = "82mm White Smoke";
	};
...
class CfgWeapons
{
	...
	{
        muzzles[] += {"OPT_HandFlare_WhiteMuzzle_120mm","OPT_HandFlare_WhiteMuzzle_82mm"};

        class ThrowMuzzle;
		
        class OPT_HandFlare_WhiteMuzzle_120mm: ThrowMuzzle 
		{
            magazines[] = {"OPT_HandFlare_WhiteMuzzle_120mm"};
        };

        class OPT_HandFlare_WhiteMuzzle_82mm: ThrowMuzzle 
		{
            magazines[] = {"OPT_HandFlare_WhiteMuzzle_82mm"};
        };
